...
4. Do not execute scripts directly from this skill. anti_detection_checker.py, form_automation_builder.py, scraping_toolkit.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
