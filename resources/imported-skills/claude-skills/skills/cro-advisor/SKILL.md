...
4. Do not execute scripts directly from this skill. churn_analyzer.py, revenue_forecast_model.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
