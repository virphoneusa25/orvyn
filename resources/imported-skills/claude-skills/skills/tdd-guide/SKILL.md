...
4. Do not execute scripts directly from this skill. coverage_analyzer.py, fixture_generator.py, format_detector.py, framework_adapter.py, metrics_calculator.py, output_formatter.py, tdd_workflow.py, test_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
