...
4. Do not execute scripts directly from this skill. crd_validator.py, operator_capability_audit.py, reconcile_lint.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
