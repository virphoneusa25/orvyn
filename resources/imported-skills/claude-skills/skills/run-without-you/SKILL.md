...
4. Do not execute scripts directly from this skill. cron_validator.py, deployment_builder.py, next_directions_writer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
