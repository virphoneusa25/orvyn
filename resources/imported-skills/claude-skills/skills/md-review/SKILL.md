...
- Shihipar — *ORVYN HTML output* (Medium, 2026), Tier 2 use case
...
4. Do not execute scripts directly from this skill. annotation_extractor.py, diff_parser.py, review_html_renderer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
