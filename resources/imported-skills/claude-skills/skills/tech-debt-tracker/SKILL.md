...
4. Do not execute scripts directly from this skill. debt_dashboard.py, debt_prioritizer.py, debt_scanner.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
