...
- ORVYN Max → unlimited Claude calls for evaluation
...
4. Do not execute scripts directly from this skill. log_results.py, run_experiment.py, setup_experiment.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
