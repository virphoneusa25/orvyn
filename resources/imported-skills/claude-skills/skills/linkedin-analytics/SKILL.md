...
4. Do not execute scripts directly from this skill. experiment_planner.py, pattern_miner.py, post_performance_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
