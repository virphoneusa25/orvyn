...
> scripts. Works in ORVYN CLI and ORVYN web. The voice is the product.
...
4. Do not execute scripts directly from this skill. anti_todo_card.py, market_first_evaluator.py, pmf_signal_scorer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
