...
Installs via plugin for ORVYN. For other tools, copy the principles into your schema file:

| Tool | Schema file |
|---|---|
| ORVYN | `CLAUDE.md` (auto-loaded by plugin) |
| Codex CLI | `AGENTS.md` |
...
4. Do not execute scripts directly from this skill. assumption_linter.py, complexity_checker.py, diff_surgeon.py, goal_verifier.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
