...
4. Do not execute scripts directly from this skill. brand_palette_validator.py, config_loader.py, onboard.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
