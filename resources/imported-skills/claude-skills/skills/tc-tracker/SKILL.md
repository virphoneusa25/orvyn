...
4. Do not execute scripts directly from this skill. tc_create.py, tc_init.py, tc_status.py, tc_update.py, tc_validator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
