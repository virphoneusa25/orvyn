...
4. Do not execute scripts directly from this skill. discovery_cadence_tracker.py, ost_linter.py, product_goal_router.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
