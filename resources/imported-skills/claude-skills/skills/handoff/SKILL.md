...
4. Do not execute scripts directly from this skill. artifact_deduplicator.py, handoff_template_generator.py, skill_recommender.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
