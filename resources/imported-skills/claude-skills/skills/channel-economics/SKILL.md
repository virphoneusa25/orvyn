...
4. Do not execute scripts directly from this skill. channel_mix_optimizer.py, channel_roi_analyzer.py, cost_to_serve_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
