...
4. Do not execute scripts directly from this skill. brand_voice_analyzer.py, content_quality_gates.py, content_scorer.py, seo_optimizer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
