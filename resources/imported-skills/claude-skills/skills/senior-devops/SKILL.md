...
4. Do not execute scripts directly from this skill. deployment_manager.py, pipeline_generator.py, terraform_scaffolder.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
