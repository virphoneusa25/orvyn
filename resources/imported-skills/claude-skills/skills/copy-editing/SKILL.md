...
4. Do not execute scripts directly from this skill. ai_content_detector.py, readability_scorer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
