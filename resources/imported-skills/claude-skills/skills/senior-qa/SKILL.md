...
4. Do not execute scripts directly from this skill. coverage_analyzer.py, e2e_test_scaffolder.py, test_suite_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
