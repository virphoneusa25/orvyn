...
4. Do not execute scripts directly from this skill. ar_evaluator.py, burn_runway_tracker.py, capex_vs_opex_router.py, config_loader.py, onboard.py, program_budget_planner.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
