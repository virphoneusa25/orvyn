...
4. Do not execute scripts directly from this skill. eval_scaffold.py, outcome_builder.py, verdict_reader.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
