...
4. Do not execute scripts directly from this skill. analyze_performance.py, calculate_metrics.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
