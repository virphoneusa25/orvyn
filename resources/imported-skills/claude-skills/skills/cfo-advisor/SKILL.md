...
4. Do not execute scripts directly from this skill. burn_rate_calculator.py, fundraising_model.py, unit_economics_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
