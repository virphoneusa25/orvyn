...
4. Do not execute scripts directly from this skill. purchasing_cycle_analyzer.py, spend_categorizer.py, supplier_consolidation.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
