...
4. Do not execute scripts directly from this skill. budget_variance_analyzer.py, dcf_valuation.py, forecast_builder.py, ratio_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
