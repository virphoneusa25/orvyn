...
4. Do not execute scripts directly from this skill. capa_tracker.py, root_cause_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
