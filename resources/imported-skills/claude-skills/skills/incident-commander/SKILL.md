...
4. Do not execute scripts directly from this skill. incident_classifier.py, pir_generator.py, timeline_reconstructor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
