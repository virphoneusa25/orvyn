...
- Shihipar — *ORVYN HTML output* (Medium, 2026), Tier 3 use case "Slide Decks"
...
4. Do not execute scripts directly from this skill. deck_html_renderer.py, presenter_notes_parser.py, slide_splitter.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
