...
4. Do not execute scripts directly from this skill. book_skill_validator.py, book_to_skill/__init__.py, book_to_skill/config.py, book_to_skill/dependencies.py, book_to_skill/exceptions.py, book_to_skill/parsers/__init__.py, book_to_skill/parsers/calibre.py, book_to_skill/parsers/docx.py, book_to_skill/parsers/epub.py, book_to_skill/parsers/html_text.py, book_to_skill/parsers/pdf.py, book_to_skill/parsers/rtf.py, book_to_skill/parsers/text.py, book_to_skill/sanitize.py, book_to_skill/utils.py, book_to_skill/zip_safety.py, extract_document.py, skill_plugin_emitter.py, token_budget_estimator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
