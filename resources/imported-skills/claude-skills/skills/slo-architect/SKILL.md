...
4. Do not execute scripts directly from this skill. error_budget_calculator.py, slo_designer.py, slo_review.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
