...
4. Do not execute scripts directly from this skill. isms_audit_scheduler.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
