...
4. Do not execute scripts directly from this skill. bookings_forecaster.py, cohort_arr_projector.py, funnel_confidence_scorer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
