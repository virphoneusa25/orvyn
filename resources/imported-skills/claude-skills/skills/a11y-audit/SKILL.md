...
4. Do not execute scripts directly from this skill. a11y_scanner.py, contrast_checker.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
