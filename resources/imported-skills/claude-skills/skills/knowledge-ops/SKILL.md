...
4. Do not execute scripts directly from this skill. kb_ingester.py, runbook_validator.py, sop_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
