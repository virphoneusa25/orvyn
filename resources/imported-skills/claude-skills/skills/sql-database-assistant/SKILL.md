...
4. Do not execute scripts directly from this skill. migration_generator.py, query_optimizer.py, schema_explorer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
