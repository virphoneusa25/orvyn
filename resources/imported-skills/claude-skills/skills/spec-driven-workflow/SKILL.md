...
4. Do not execute scripts directly from this skill. spec_generator.py, spec_validator.py, test_extractor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
