...
4. Do not execute scripts directly from this skill. data_subject_rights_tracker.py, dpia_generator.py, gdpr_compliance_checker.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
