...
4. Do not execute scripts directly from this skill. delivery_throughput_analyzer.py, eng_hiring_funnel_calculator.py, eng_team_structure_designer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
