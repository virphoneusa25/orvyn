...
- **ORVYN config** — workspace-aware CLAUDE.md with per-package instructions
...
4. Do not execute scripts directly from this skill. monorepo_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
