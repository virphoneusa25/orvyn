...
4. Do not execute scripts directly from this skill. metrics_calculator.py, quick_ratio_calculator.py, unit_economics_simulator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
