...
4. Do not execute scripts directly from this skill. project_health_dashboard.py, resource_capacity_planner.py, risk_matrix_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
