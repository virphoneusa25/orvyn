...
4. Do not execute scripts directly from this skill. auth_setup_guide.py, gws_doctor.py, gws_recipe_runner.py, output_analyzer.py, workspace_audit.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
