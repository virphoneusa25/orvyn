...
4. Do not execute scripts directly from this skill. action_item_extractor.py, agenda_builder.py, meeting_cost_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
