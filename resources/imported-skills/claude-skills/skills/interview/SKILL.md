...
4. Do not execute scripts directly from this skill. build_sheet_builder.py, interview_planner.py, primitives_validator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
