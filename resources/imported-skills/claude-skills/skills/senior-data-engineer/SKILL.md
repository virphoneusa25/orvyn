...
4. Do not execute scripts directly from this skill. data_quality_validator.py, etl_performance_optimizer.py, pipeline_orchestrator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
