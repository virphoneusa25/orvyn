...
4. Do not execute scripts directly from this skill. cadence_planner.py, newsletter_planner.py, positioning_brief.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
