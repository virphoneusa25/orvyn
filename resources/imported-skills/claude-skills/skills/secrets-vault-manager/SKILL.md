...
4. Do not execute scripts directly from this skill. audit_log_analyzer.py, rotation_planner.py, vault_config_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
