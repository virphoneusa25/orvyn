...
4. Do not execute scripts directly from this skill. dataset_pipeline_builder.py, inference_optimizer.py, vision_model_trainer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
