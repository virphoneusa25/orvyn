...
4. Do not execute scripts directly from this skill. ad_health_scorer.py, roas_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
