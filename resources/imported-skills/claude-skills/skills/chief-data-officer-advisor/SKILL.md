...
4. Do not execute scripts directly from this skill. ai_training_data_audit.py, data_asset_valuator.py, data_product_strategy_picker.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
