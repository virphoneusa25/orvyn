...
4. Do not execute scripts directly from this skill. joint_gtm_planner.py, partner_tier_classifier.py, revshare_modeler.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
