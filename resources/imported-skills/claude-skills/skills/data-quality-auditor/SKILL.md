...
4. Do not execute scripts directly from this skill. data_profiler.py, missing_value_analyzer.py, outlier_detector.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
