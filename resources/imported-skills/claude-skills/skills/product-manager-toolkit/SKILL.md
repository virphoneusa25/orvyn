...
4. Do not execute scripts directly from this skill. customer_interview_analyzer.py, rice_prioritizer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
