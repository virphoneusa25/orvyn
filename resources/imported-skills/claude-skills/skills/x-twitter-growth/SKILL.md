...
4. Do not execute scripts directly from this skill. competitor_analyzer.py, content_planner.py, growth_tracker.py, profile_auditor.py, tweet_composer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
