...
4. Do not execute scripts directly from this skill. pmf_scorer.py, portfolio_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
