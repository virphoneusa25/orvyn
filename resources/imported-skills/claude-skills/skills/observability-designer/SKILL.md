...
4. Do not execute scripts directly from this skill. alert_optimizer.py, dashboard_generator.py, slo_designer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
