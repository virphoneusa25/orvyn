...
4. Do not execute scripts directly from this skill. change_announcement_builder.py, comms_calendar_builder.py, comms_template_filler.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
