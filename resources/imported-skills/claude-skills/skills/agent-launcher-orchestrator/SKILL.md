...
4. Do not execute scripts directly from this skill. goal_router.py, goal_state.py, loop_compiler.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
