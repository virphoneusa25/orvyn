...
4. Do not execute scripts directly from this skill. contract_risk_scanner.py, term_sheet_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
