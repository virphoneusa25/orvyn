...
4. Do not execute scripts directly from this skill. architecture_designer.py, cost_optimizer.py, deployment_manager.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
