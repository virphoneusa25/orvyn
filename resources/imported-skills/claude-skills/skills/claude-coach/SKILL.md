...
4. Do not execute scripts directly from this skill. cheat_code_filter.py, coach_tip_classifier.py, prompt_rater.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
