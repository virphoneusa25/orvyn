...
fields ORVYN reads: anything else here gets copied into new skills by
...
4. Do not execute scripts directly from this skill. text_processor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
