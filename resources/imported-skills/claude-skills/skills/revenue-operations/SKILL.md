...
4. Do not execute scripts directly from this skill. forecast_accuracy_tracker.py, gtm_efficiency_calculator.py, pipeline_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
