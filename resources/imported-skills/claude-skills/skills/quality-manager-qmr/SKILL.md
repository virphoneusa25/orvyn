...
4. Do not execute scripts directly from this skill. management_review_tracker.py, quality_effectiveness_monitor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
