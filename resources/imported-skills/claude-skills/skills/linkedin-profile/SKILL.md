...
4. Do not execute scripts directly from this skill. about_section_builder.py, headline_scorer.py, profile_completeness_auditor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
