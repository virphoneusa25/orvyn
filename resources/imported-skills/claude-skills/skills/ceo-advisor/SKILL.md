...
4. Do not execute scripts directly from this skill. financial_scenario_analyzer.py, strategy_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
