...
4. Do not execute scripts directly from this skill. capacity_modeler.py, hiring_sequencer.py, utilization_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
