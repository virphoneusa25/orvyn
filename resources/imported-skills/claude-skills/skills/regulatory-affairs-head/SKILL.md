...
4. Do not execute scripts directly from this skill. regulatory_pathway_analyzer.py, regulatory_tracker.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
