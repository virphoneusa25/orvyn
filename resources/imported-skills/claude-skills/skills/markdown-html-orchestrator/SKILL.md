...
- Spec: Thariq Shihipar — "ORVYN HTML output" (Medium, 2026)
...
4. Do not execute scripts directly from this skill. doctype_classifier.py, output_path_resolver.py, route_explainer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
