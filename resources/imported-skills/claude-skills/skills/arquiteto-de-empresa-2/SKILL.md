...
4. Do not execute scripts directly from this skill. index_generator.py, okf_linter.py, scaffold_bundle.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
