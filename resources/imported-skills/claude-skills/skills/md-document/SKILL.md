...
- Shihipar — *ORVYN HTML output* (Medium, 2026)
...
4. Do not execute scripts directly from this skill. html_renderer.py, interactivity_injector.py, markdown_parser.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
