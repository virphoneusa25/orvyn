...
4. Do not execute scripts directly from this skill. audit_simulator.py, cross_framework_mapper.py, evidence_pool_generator.py, framework_selector.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
