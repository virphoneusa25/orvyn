...
4. Do not execute scripts directly from this skill. ai_risk_register_builder.py, aims_audit_scheduler.py, aims_gap_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
