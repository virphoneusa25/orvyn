...
4. Do not execute scripts directly from this skill. response_drafter.py, rfp_parser.py, winrate_predictor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
