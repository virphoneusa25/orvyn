...
4. Do not execute scripts directly from this skill. powershell_generator.py, tenant_setup.py, user_management.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
