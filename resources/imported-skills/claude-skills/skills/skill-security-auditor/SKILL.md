...
description: >
  ...
  ORVYN plugins, OpenClaw skills, or Codex skills, (4) scanning Python scripts
...
4. Do not execute scripts directly from this skill. skill_security_auditor.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
