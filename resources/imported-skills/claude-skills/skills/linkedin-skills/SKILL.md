...
4. Do not execute scripts directly from this skill. linkedin_goal_router.py, linkedin_policy_gate.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
