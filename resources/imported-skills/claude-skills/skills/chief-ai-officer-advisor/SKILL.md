...
4. Do not execute scripts directly from this skill. ai_cost_economics.py, ai_risk_classifier.py, model_buildvsbuy_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
