...
4. Do not execute scripts directly from this skill. adr_scanner.py, context_md_linter.py, glossary_code_consistency.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
