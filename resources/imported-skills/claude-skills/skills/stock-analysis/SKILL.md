...
4. Do not execute scripts directly from this skill. benchmarks.json, lint_report.py, ratios.py, score.py, valuation.py, verify_data.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
