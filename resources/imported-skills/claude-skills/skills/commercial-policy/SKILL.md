...
4. Do not execute scripts directly from this skill. discount_matrix_builder.py, exception_router.py, policy_linter.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
