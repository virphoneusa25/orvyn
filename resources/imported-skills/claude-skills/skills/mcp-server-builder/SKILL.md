...
4. Do not execute scripts directly from this skill. mcp_validator.py, openapi_to_mcp.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
