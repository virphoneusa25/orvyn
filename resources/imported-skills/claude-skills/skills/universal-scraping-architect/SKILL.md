...
4. Do not execute scripts directly from this skill. firecrawl_example.py, local_bs4_example.py, validate_extraction.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
