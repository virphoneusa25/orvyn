...
4. Do not execute scripts directly from this skill. code_quality_checker.py, pr_analyzer.py, review_report_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
