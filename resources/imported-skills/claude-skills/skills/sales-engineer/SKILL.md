...
4. Do not execute scripts directly from this skill. competitive_matrix_builder.py, poc_planner.py, rfp_response_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
