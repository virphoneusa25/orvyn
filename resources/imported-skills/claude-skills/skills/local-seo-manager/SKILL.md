...
4. Do not execute scripts directly from this skill. nap_checker.py, schema_generator.py, service_area_generator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
