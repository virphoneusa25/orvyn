...
4. Do not execute scripts directly from this skill. cs_coverage_calculator.py, customer_segmentation_designer.py, retention_decomposition_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
