...
4. Do not execute scripts directly from this skill. compliance_checker.py, risk_assessment.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
