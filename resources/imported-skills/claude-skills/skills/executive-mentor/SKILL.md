...
4. Do not execute scripts directly from this skill. decision_matrix_scorer.py, stakeholder_mapper.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
