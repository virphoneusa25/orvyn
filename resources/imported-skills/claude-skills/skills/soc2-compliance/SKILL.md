...
4. Do not execute scripts directly from this skill. control_matrix_builder.py, evidence_tracker.py, gap_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
