...
4. Do not execute scripts directly from this skill. comment_target_planner.py, outreach_message_builder.py, outreach_volume_guard.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
