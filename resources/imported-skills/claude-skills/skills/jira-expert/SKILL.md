...
4. Do not execute scripts directly from this skill. jql_query_builder.py, workflow_validator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
