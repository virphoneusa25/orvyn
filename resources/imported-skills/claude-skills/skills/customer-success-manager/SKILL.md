...
4. Do not execute scripts directly from this skill. churn_risk_analyzer.py, expansion_opportunity_scorer.py, health_score_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
