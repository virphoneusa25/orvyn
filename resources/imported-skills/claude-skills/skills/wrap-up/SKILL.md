...
4. Do not execute scripts directly from this skill. overview_page.py, primitives_inventory.py, upgrade_suggester.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
