...
4. Do not execute scripts directly from this skill. document_validator.py, document_version_control.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
