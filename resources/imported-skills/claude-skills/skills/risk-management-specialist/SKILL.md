...
4. Do not execute scripts directly from this skill. fmea_analyzer.py, risk_matrix_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
