...
(`https://mcp.atlassian.com/v1/sse`, OAuth handled by ORVYN).
...
4. Do not execute scripts directly from this skill. delivery_loop_gate.py, jira_snapshot_bridge.py, pm_goal_router.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
