...
4. Do not execute scripts directly from this skill. blast_radius_calculator.py, experiment_designer.py, experiment_postmortem.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
