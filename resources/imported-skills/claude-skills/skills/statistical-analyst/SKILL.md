...
4. Do not execute scripts directly from this skill. confidence_interval.py, hypothesis_tester.py, sample_size_calculator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
