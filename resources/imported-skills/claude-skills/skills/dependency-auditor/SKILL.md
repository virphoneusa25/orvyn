...
4. Do not execute scripts directly from this skill. dep_scanner.py, license_checker.py, upgrade_planner.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
