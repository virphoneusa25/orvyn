...
4. Do not execute scripts directly from this skill. commit_linter.py, generate_changelog.py, version_bumper.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
