...
4. Do not execute scripts directly from this skill. bottleneck_detector.py, cycle_time_analyzer.py, process_documenter.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
