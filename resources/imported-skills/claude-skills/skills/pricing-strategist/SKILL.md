...
4. Do not execute scripts directly from this skill. packaging_designer.py, pricing_model_picker.py, wtp_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
