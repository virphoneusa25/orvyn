...
4. Do not execute scripts directly from this skill. ai_act_obligation_tracker.py, ai_system_risk_classifier.py, conformity_assessment_planner.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
