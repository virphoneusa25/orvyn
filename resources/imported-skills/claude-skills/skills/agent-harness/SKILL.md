...
- **workflow-builder**: authoring deterministic `.js` scripts for ORVYN's Workflow
...
4. Do not execute scripts directly from this skill. goal_compiler.py, harness_manifest_builder.py, loop_controller.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
