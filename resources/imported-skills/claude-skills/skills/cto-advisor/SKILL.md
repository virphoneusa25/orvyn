...
4. Do not execute scripts directly from this skill. team_scaling_calculator.py, tech_debt_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
