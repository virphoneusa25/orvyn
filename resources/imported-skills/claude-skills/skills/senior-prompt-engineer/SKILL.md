...
4. Do not execute scripts directly from this skill. agent_orchestrator.py, prompt_optimizer.py, rag_evaluator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
