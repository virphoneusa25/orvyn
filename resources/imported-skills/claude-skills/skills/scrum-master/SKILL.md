...
4. Do not execute scripts directly from this skill. retrospective_analyzer.py, sprint_health_scorer.py, velocity_analyzer.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
