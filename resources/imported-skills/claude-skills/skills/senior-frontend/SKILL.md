...
4. Do not execute scripts directly from this skill. bundle_analyzer.py, component_generator.py, frontend_decision_engine.py, frontend_scaffolder.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
