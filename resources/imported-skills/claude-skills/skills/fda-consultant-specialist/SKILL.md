...
4. Do not execute scripts directly from this skill. fda_submission_tracker.py, hipaa_risk_assessment.py, qsr_compliance_checker.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
