...
4. Do not execute scripts directly from this skill. quality_scorer.py, script_tester.py, security_scorer.py, skill_validator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
