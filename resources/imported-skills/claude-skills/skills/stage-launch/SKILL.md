...
4. Do not execute scripts directly from this skill. launch_script_writer.py, payload_generator.py, payload_validator.py may run only through the terminal tool, which uses ToolGateway, PermissionEngine, and ExecutionProvider. High-risk scripts stay disabled: none.
