...
Trace a bad setting to the file and key that the process actually loaded.
...
2. Find which file the process loaded. Do not edit a sample file and call it the live config.
3. Cite the key and the log or file evidence. Preserve the rest of the file.
