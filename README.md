...
- **Intelligence UI** — center chat/stream plus one Agent Workspace panel
  (Preview / Changes / Files / Diff / Terminal / Browser / Review tabs,
  Follow ORION switches the active tab only); Mission Control; Agent
